...
export const gradients = {
  ...
  darkOverlay:
    'linear-gradient(135deg, rgba(15, 23, 42, 0.95) 0%, rgba(88, 28, 135, 0.9) 35%, rgba(30, 58, 138, 0.9) 70%, rgba(15, 23, 42, 0.95) 100%)',
  ...
  purpleBubble:
    'radial-gradient(circle, rgba(167, 139, 250, 0.4) 0%, rgba(167, 139, 250, 0.1) 70%, transparent 100%)',
...
export const shadows = {
  ...
  // Text shadows
  titleShadow:
    '3px 3px 0 #FFD166, 6px 6px 0 #9b87f5, 9px 9px 20px rgba(0,0,0,0.3)',
