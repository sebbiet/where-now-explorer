  ...
  return (
    <div className="flex flex-col items-center justify-center p-8">
      ...
      <div className="relative w-32 h-32">
        ...
        <div
          className="absolute inset-2 rounded-full border-4 border-t-soft-orange border-r-soft-green border-b-soft-yellow border-l-soft-purple animate-spin"
          style={{
            animationDirection: 'reverse',
            animationDuration: animations.durations.extended,
          }}
        ></div>
        ...
        <div
          ...
          style={{ animationDuration: animations.durations.prolonged }}
        >
