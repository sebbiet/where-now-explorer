...
const ProductionStatus: React.FC = () => {
  ...
  const uptime = status.healthStatus?.uptime
    ? Math.round(status.healthStatus.uptime / 1000 / 60)
    : 0; // minutes
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transition-all duration-300">
      {/* Header */}
      <div
        className="bg-gradient-to-r from-blue-600 to-purple-600 p-3 text-white cursor-pointer"
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-sm font-bold">Production Status</h3>
        ...
        <div className="p-4 space-y-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {status.healthStatus?.checks?.map((check: HealthCheck) => (
                <div
                  key={check.name}
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-3">
                <div className="text-xl font-bold text-purple-600 dark:text-purple-400">
                  {Math.round(
                    (Date.now() - (status.analytics?.startTime || Date.now())) /
                      1000 /
                      60
                  )}
                </div>
