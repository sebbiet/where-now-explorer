  ...
  return (
    <div className="flex justify-center mb-8 relative">
      ...
      <div className="relative animate-bounce">
        ...
        <div
          className="absolute top-8 -right-4 text-xl animate-pulse"
          style={{ animationDelay: '0.5s' }}
        >
          ⭐
        </div>
        <div
          className="absolute bottom-4 -left-2 text-lg animate-pulse"
