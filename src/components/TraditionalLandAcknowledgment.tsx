...
const TraditionalLandAcknowledgment: React.FC<
  TraditionalLandAcknowledgmentProps
> = ({ traditionalName, traditionalNation }) => {
  return (
    <div
      className="w-full max-w-4xl mt-6 relative backdrop-blur-2xl rounded-3xl p-8 animate-fade-in"
      style={{
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-center mb-6">
          <div
            ...
            style={{
              background:
                'linear-gradient(135deg, #D97706 0%, #92400E 50%, #78350F 100%)',
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed max-w-3xl mx-auto">
            ...
            <span className="font-bold">{traditionalName}</span>, the land on
