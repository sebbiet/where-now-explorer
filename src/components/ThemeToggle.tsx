    ...
    >
      ...
      <div className={`absolute inset-0 flex items-center justify-center transition-all ${
        ...
        <div className="absolute inset-0">
          ...
          <span className="absolute bottom-4 left-3 text-sm animate-pulse" style={{animationDelay: animations.delays.minimal}}>⭐</span>
          <span className="absolute top-5 left-5 text-xs animate-pulse" style={{animationDelay: animations.delays.short}}>✨</span>
        </div>
      </div>
